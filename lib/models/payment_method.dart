...
String extractDisplayLanguage(Map<String, String>? langMap,
    {String langCode = 'IT'}) {
...
class PaymentMethod {
  ...
  factory PaymentMethod.fromJson(Map<String, dynamic> json) {
    return PaymentMethod(
      ...
      userTouchpoint: json['user_touchpoint'] != null
          ? List<String>.from(json['user_touchpoint'])
          : null,
      userDevice: json['user_device'] != null
          ? List<String>.from(json['user_device'])
          : null,
      validityDateFrom: json['validity_date_from'] != null
          ? DateTime.parse(json['validity_date_from'])
          : null,
      rangeAmount: json['range_amount'] != null
          ? FeeRange.fromJson(json['range_amount'])
          : FeeRange(min: 0, max: 0),
      paymentMethodAsset: json['payment_method_asset'],
      methodManagement: json['method_management'],
      paymentMethodsBrandAssets: json['payment_methods_brand_assets'] != null
          ? Map<String, String>.from(json['payment_methods_brand_assets'])
          : null,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (validityDateFrom != null) {
      data['validity_date_from'] =
          DateFormat('yyyy-MM-dd').format(validityDateFrom!);
    }
    if (rangeAmount != null) data['range_amount'] = rangeAmount!.toJson();
    if (paymentMethodAsset != null) {
      data['payment_method_asset'] = paymentMethodAsset;
    }
    if (methodManagement != null) data['method_management'] = methodManagement;
    if (paymentMethodsBrandAssets != null) {
      data['payment_methods_brand_assets'] = paymentMethodsBrandAssets;
    }
    return data;
  }
}
